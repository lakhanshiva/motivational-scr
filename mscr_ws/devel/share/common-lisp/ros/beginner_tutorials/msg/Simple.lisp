...
(cl:defmethod cl:initialize-instance :after ((m <Simple>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Simple)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name beginner_tutorials-msg:<Simple> is deprecated: use beginner_tutorials-msg:Simple instead.")))

(cl:ensure-generic-function 'num-val :lambda-list '(m))
(cl:defmethod num-val ((m <Simple>))
...
(cl:defmethod first_name-val ((m <Simple>))
...
(cl:defmethod last_name-val ((m <Simple>))
...
(cl:defmethod score-val ((m <Simple>))
